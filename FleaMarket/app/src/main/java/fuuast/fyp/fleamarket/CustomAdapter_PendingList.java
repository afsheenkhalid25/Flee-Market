...
public class CustomAdapter_PendingList extends BaseAdapter {

    Context context;
    ArrayList shop_names,shop_categories,market_names;
    TextView shop_name,shop_category,market_name;

    public CustomAdapter_PendingList(Context context, ArrayList names, ArrayList categories, ArrayList market_name) {
